            ...
            <div class="sidebar sidebar-main">
                <div class="sidebar-content">
                    ...
                    <div class="sidebar-user">
                        <div class="designations-content">
                            <div class="media">
                ...
                <div class="content">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h5 class="panel-title">Designations Create</h5>
                            <div class="heading-elements">
                                <ul class="icons-list">
                                    <li><a href="designations_create.php" class="btn btn-primary add-new">Add New</a>
                                    </li>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal mt-10" action="designations_control.php" method="POST">
                                ...
                                <div class="text-right">
                                    <input type="submit" value="Save Data" name="save_designations"
                                        class="btn btn-primary">

                                    <a href="designations_view.php" class="btn btn-info">Back To View</a>
                                </div>
