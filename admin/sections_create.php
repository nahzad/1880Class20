                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            ...
                            <div class="heading-elements">
                                <ul class="icons-list">
                                    <li><a href="sections_create.php" class="btn btn-primary add-new">Add New</a></li>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal mt-10" action="sections_control.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea rows="5" cols="5" class="form-control"
                                                placeholder="Your Messages Here " id="details"
                                ...
                                <div class="text-right">
                                    <input type="submit" value="Save Data" name="save_sections" class="btn btn-primary">
